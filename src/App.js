...
import { FaReact, FaVuejs, FaNodeJs, FaGithub, FaLinkedin, FaWhatsapp, FaEnvelope, FaGit, FaGitAlt } from 'react-icons/fa';
import { SiExpress, SiDjango, SiFlask, SiNextdotjs, SiFastapi, SiMongodb, SiPostgresql, SiMysql } from 'react-icons/si';
...
const App = () => {
  ...
  const testimonials = [
    {
      name: "Akintewe Mary",
      position: "CEO, Timardor global resource",
    ...
    {
      name: "Michel E. Milligi",
      position: "CEO, Reboot Monkey",
      quote: "Working with Gentle was a pleasure. He's so quick to learn .He delivered our application ahead of schedule and exceeded all our performance expectations.",
      image: "avatar1.jpg"
    },
    {
      name: "Isreal",
      position: "Founder, Rebrand the brand",
          ...
          >
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  <SiNextdotjs className="text-3xl text-green-500 mr-4" />
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                ...
                <div className="flex items-center">
                  <FaVuejs className="text-3xl text-red-500 mr-4" />
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  <SiFlask className="text-3xl text-teal-500 mr-4" />
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  <SiPostgresql className="text-3xl text-green-500 mr-4" />
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                ...
                <div className="flex items-center">
                  <FaGit className="text-3xl text-green-500 mr-4" />
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
