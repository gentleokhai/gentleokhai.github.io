        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl mb-8 h-12 font-medium">
              ...
              <span className="animate-pulse ml-1 inline-block w-0.5 h-6 bg-yellow-300 align-middle">
                |
              </span>
            </h2>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39
              C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V16.22
              C86.06,53.58,183.93,73.45,321.39,56.44Z"
            fill="currentColor"
